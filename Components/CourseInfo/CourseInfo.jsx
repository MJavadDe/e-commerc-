...
const CourseInfo = ({quantity = 6 ,level = "متوسط",language = "فارسی" ,data}) => {
    console.log(data);
    return (
        <div className='rounded-xl flex flex-col p-5 shadow-2xl font-vazir' >
            <div className=' text-xl border-b-2 border-gray-200 p-5 flex '> <span className='sm:block hidden'>قیمت این دوره  &nbsp;  :  </span> &nbsp; <span className='text-[#46A194]'><PriceFormat price={data.price}/></span></div>
            <div className="courseInfoBody flex flex-col gap-3 p-5">
                <div className="InfoWrapper flex justify-start gap-3 ">
                    ...
                    <span className='text-gray-500'>مدرس دوره &nbsp; : <span className='text-black'>{data.teacher.name}</span> </span>
                </div>
                ...
                <div className="InfoWrapper flex justify-start gap-3 mt-4">
                    ...
                    <span className='text-gray-500'> مدت زمان دوره &nbsp; : <span className='text-[#2EB5DD]'>{data.duration}</span> </span>
                </div>
                <div className="InfoWrapper flex justify-start gap-3 mt-4">
            ...
            <Button className={"bg-[#46A194] text-center w-11/12 p-3 rounded-lg m-auto mb-2 mt-4 cursor-pointer text-white"}>ثبت نام در این دوره</Button>
        </div>
    );
};
