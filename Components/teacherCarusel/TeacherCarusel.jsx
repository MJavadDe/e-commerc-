...
function TeacherCarusel(props) {
    return (
        <div className='w-full bg-secondary-very-light min-h-[300px] rounded-lg flex flex-col justify-between lg:flex-row-reverse px-15 pb-7 pt-9 font-vazir gap-8'>
