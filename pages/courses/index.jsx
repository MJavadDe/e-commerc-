  ...
  return (
    <Layout title="Courses">
      <div className=" flex flex-col font-vazir">
        <div className="flex lg:flex-row justify-between md:gap-5 bg-secondary-very-light lg:h-[4.3rem] md:h-[7rem] rounded-xl items-center mb-10 lg:text-base md:text-sm sm:text-sm p-3 md:flex-col sm:flex-col sm:gap-5">
